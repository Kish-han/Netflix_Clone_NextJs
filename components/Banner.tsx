            ...
            <div className='relative w-screen h-[80vh]'>
                ...
                <div className="absolute top-56 left-5 md:top-64 max-w-2xl">
                    ...
                    <div className="flex space-x-4 mt-4">
                        ...
                        <button className="bannerButton bg-[gray]/70"> More Info<InformationCircleIcon className='h-5 w-5 md:h-7 md:w-8'/></button>
                    </div>
                </div>
                {/* <div className="h-[9rem] bg-gradient-to-b from-[black]/5 to-bg-[black] absolute bottom-0 left-0 right-0"></div> */}
            </div>
        </>
    )
}
